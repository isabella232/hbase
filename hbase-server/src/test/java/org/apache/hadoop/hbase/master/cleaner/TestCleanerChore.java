...
public class TestCleanerChore {
  ...
  public void testOnConfigurationChange() throws Exception {
    ...
    assertTrue(changedPoolSize == chore.getChorePoolSize());
    // Stop chore
    t.join();
  }
  ...
  public void testMinimumNumberOfThreads() throws Exception {
    ...
    // Sanity
    assertTrue(numProcs == chore.calculatePoolSize(Integer.toString(numProcs)));
    // The implementation does not allow us to set more threads than we have processors
    assertTrue(numProcs == chore.calculatePoolSize(Integer.toString(numProcs + 2)));
    // Force us into the branch that is multiplying 0.0 against the number of processors
    assertTrue(1 == chore.calculatePoolSize("0.0"));
  }
